...
#     text = f'{name}:, CosSim={distances["Cosine Similarity"]:.2f} '
#     cv2.putText(img, text, (x_start, y_start - 10), cv2.FONT_HERSHEY_PLAIN, 1, (0, 255, 0), 2)

# image_path = "/Users/tunglambg131003/Real-time_Face_Recognition/test_img2.jpg"  
...
#         best_id = min(distances, key=lambda id_: distances[id_]["Cosine Similarity"])
...
image_paths = [
    "/Users/tunglambg131003/Real-time_Face_Recognition/test_img2.jpg",
    "/Users/tunglambg131003/Real-time_Face_Recognition/test_data/0/hiepnm_3.jpg",
    "/Users/tunglambg131003/Real-time_Face_Recognition/test_data/21/lamnt2_4.jpg",
...
for image_path in image_paths:
    ...
    if not faces_detected:
        ...
        for face in faces_detected:
            ...
            best_id = min(distances, key=lambda id_: distances[id_]["Cosine Similarity"])
            predicted_name = name.get(str(face_recognizer.getLabels()[best_id][0]), "Unknown")
            print(f"Image: {image_path} - {distances[best_id]["Cosine Similarity"]:.2f} ({predicted_name})")
